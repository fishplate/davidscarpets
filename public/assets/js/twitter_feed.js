  ...
  loadTweets: function() {
    $.ajax({
      ...
      success: function(data, textStatus, xhr) {
         ...
         var html = '<div class="tweet"> <p class="tweetText">TWEET_TEXT</p> IMG_TAG<div class="time">AGO</div>';
         var img;
        ...
        try {
          if (data[i].entities.media) {
            ...
            img += '<img src="' + data[i].entities.media[0].media_url + '" alt="" class="twitterImage"  />';
            img += '</a>';
          } else {
            img = '';
          }
